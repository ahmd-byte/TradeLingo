...
async def chat(
    ...
    try:
        ...
        # result is a dict, not an AgentState object - use bracket notation
        ...
        logger.info(f"Chat request from user: {current_user.email}, intent: {result_intent}")
        return final_output or {"error": "No output generated"}
...
async def therapy(
    ...
    try:
        ...
        logger.info(f"Therapy request from user: {current_user.email}, intent: {result_intent}")
        return final_output or {"error": "No output generated"}
