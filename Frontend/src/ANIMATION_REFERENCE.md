...
### Components:
- `/components/figma/QuizFlow.tsx` - Diagnostic quiz with end screen
- `/components/figma/UserProfiling.tsx` - Onboarding + Deriv reveal
...
### Assets:
- `/imports/` - Figma images
- `figma:asset/...` - Import scheme for images
